...
<body class="d-flex flex-column">
      ...
      <nav class="navbar navbar-expand-lg navbar-dark">
        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
          <ul class="navbar-nav ms-auto mb-2 mb-lg-0 mt-5 mt-lg-0">
            ...
            <li class="nav-item">
              <a class="nav-link <?= NavigationTools::addActiveClass('/all-games') ?>" href="<?= constant('URL_SUBFOLDER') . '/' ?>" target="_blank">
                <?php
                // TODO Si besoin : Déconnexion avant redirection 
                ?>
                <svg xmlns="http://www.w3.org/2000/svg" width="22" height="22" fill="currentColor" class="bi bi-arrow-up-short" viewBox="0 0 16 16">
                  <path fill-rule="evenodd" d="M8 12a.5.5 0 0 0 .5-.5V5.707l2.146 2.147a.5.5 0 0 0 .708-.708l-3-3a.5.5 0 0 0-.708 0l-3 3a.5.5 0 1 0 .708.708L7.5 5.707V11.5a.5.5 0 0 0 .5.5" />
                </svg>Retour vers le site
              </a>
            </li>
  ...
  <main class="flex-shrink-0 pb-5">
    ...
    <div class="banner text-center">
      <h1 class="display-5 fw-bold text-white">Espace Commentateur</h1>
    </div>
    <!-- Banner -->